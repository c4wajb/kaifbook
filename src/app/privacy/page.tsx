...
export default function PrivacyPage() {
  return (
    <main className="page legal-page">
      ...
      <p>Сервис использует только технические cookie: один файл сессии нужен для входа в аккаунт и работы бронирования и хранится до 7 дней. Рекламных и аналитических cookie у нас нет. Отключить cookie можно в настройках браузера, но тогда вход в кабинет работать не будет.</p>
